...
function App() {
  ...
  return (
    <div id="main">
      ...
      >
        {states[state].city.map((place, index) => {
          return (
            <option key={index} value={index}>
              {states[state].city[index].name}
            </option>
          );
        })}
      </select>{" "}
      ...
      >
        {states[state].city[city].landmarks.map((place, index) => {
          return (
            <option key={index} value={index}>
              {states[state].city[city].landmarks[index].name}
            </option>
          );
        })}
      </select>{" "}
